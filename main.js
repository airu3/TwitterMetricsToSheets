...
const sheetInfo = [
	{
		name: "佐藤　個人管理表", // シート名
		sheetId: "1fMWBLjOgLquLMBFmLmsW9-sB5rb3DoEFU1nyqT7knBY", // スプレッドシートID
		sheetName: "アカウント日報", // シート名
		dateRange: "A:A", // 日付の範囲
		cell: {
			// メトリクス名と列名の対応
			following: ["C"], // 1列に対応
	...
	},
	{
		...
		cellOffsets: {
			row: [0, 1, 2, 3, 4], // 列オフセット
			col: [0, 1], // 行オフセット
		},
	},
	{
		name: "伊藤チーム　管理表",
		sheetId: "1Cwt0GanTSrYWTM29pDGcRP-uxLo8BPkzUuNoF88yzWE",
		sheetName: "ff管理",
		dateRange: "5:5",
		surnameRange: "A:A",
		cell: {
	...
	{
		name: "風間チーム　管理表",
		sheetId: "1sPdP11cnnkCYmkjc061AeKmuv9rR5CWyNi1-ScnFJxk",
		sheetName: "ff管理",
		dateRange: "5:5",
		surnameRange: "A:A",
		cell: {
	...
	{
		name: "御手洗チーム　管理表",
		sheetId: "1j3be3J_Pef5Y0wPiZIPZMNkh2FMJc-sr07CxRSXiVUc",
		sheetName: "ff管理",
		dateRange: "5:5",
		surnameRange: "A:A",
		cell: {
